...
如前所述，如果您想完全控制“丑陋”的控件类型，则只能依靠JavaScript。在“ [如何构建自定义表单控件”一文中，](https://developer.mozilla.org/en-US/docs/Learn/Forms/How_to_build_custom_form_controls)您将看到如何自己执行此操作，但是那里有一些非常有用的库可以帮助您：
