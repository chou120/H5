...
在开始这个模块之前，您至少应该完成我们[对HTML的介绍](https://developer.mozilla.org/zh-CN/docs/Learn/HTML/Introduction_to_HTML)。此时此刻，您应该会发现[基本指南](https://developer.mozilla.org/zh-CN/docs/Learn/HTML/Forms#基本指南)很容易理解，并且能够使用我们的[原生表单小部件](https://developer.mozilla.org/zh-CN/docs/Learn/HTML/Forms/The_native_form_widgets)指南。
