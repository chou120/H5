在前面的几篇文章中，我们介绍了创建和构建Web表单所需的所有HTML。在本文中，我们将继续研究如何使用[CSS](https://developer.mozilla.org/en-US/docs/CSS)设置表单控件的样式。从历史上讲，这一直很困难-表单控件在CSS中自定义的难易程度相差很大-但随着旧浏览器的淘汰和现代浏览器的使用，我们变得越来越容易。
