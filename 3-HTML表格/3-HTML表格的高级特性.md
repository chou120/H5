...
| 学习本章节的前提条件: | HTML 的基础知识 (see [Introduction to HTML](1/en-US/docs/Learn/HTML/Introduction_to_HTML)). |
| :-------------------- | ------------------------------------------------------------ |
...
**注意**: 总是包含在每个表中，如果你没有在代码中指定它，那就是隐式的。可以来验证一下，打开一个你之前没有包含 的例子，然后在你的 [browser developer tools](1/en-US/docs/Learn/Common_questions/What_are_browser_developer_tools) 中观察你的代码，你会看到浏览器为你添加了这个标签。你也许会想问，为什么你应该在所有表中都需要这个元素，因为它可以让你更好地控制表格结构和样式。
