该模块继续执行[CSS的第一步](https://developer.mozilla.org/en-US/docs/Learn/CSS/First_steps) -现在您已经熟悉了该语言及其语法，并获得了一些使用它的基本经验，并且有时间进一步深入。该模块研究级联和继承，所有可用的选择器类型，单位，大小，背景和边框样式，调试等。
